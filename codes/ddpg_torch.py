...
class ActorNetwork(nn.Module):
    ...
    def forward(self, state):
        ...
        # x = T.clamp(x, min = 0.01)
        # print(type(x), x, x.size())
        # print(x.item())
        return x
...
class Agent(object):
    def __init__(self, alpha, beta, input_dims, tau, gamma=0.99, n_actions=2, max_size=1000000, layer1_size=400, layer2_size=300, batch_size=64):
        self.gamma = gamma
        self.tau = tau
